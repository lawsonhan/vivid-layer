  ...
  return (
    <MessageScrollerProvider scrollMargin={12}>
      <div className="flex h-[42rem] w-full items-center justify-center p-4 sm:p-6">
        <div className="grid h-[36rem] w-full max-w-2xl grid-cols-[4rem_minmax(0,1fr)] overflow-hidden rounded-xl bg-background">
          <ChatMinimap
            items={turns}
            className="col-start-1 row-start-1 self-center justify-self-center"
            {...minimapProps}
          />
          <MessageScroller className="col-start-2 row-start-1">
            <MessageScrollerViewport>
